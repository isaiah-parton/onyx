...
/*
    ...
    void main()
    {
        gl_Position = vec4(fma(pos / tex[0].xy, vec2(1.0, -1.0), vec2(-1.0, 1.0)), 0.0, 1.0);
        texCoord = uv;
        color = col;
    }
...
vs_source_glsl430 := [358]u8 {
    ...
    0x76,0x65,0x63,0x32,0x28,0x31,0x2e,0x30,0x2c,0x20,0x2d,0x31,0x2e,0x30,0x29,0x2c,
...
/*
    ...
    void main()
    {
        gl_Position = vec4((pos / tex[0].xy) * vec2(1.0, -1.0) + vec2(-1.0, 1.0), 0.0, 1.0);
        texCoord = uv;
        color = col;
    }
...
vs_source_glsl300es := [318]u8 {
    ...
    0x5d,0x2e,0x78,0x79,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,0x32,0x28,0x31,0x2e,0x30,
    0x2c,0x20,0x2d,0x31,0x2e,0x30,0x29,0x20,0x2b,0x20,0x76,0x65,0x63,0x32,0x28,0x2d,
...
/*
    ...
    void vert_main()
    {
        gl_Position = float4(mad(pos / _25_texSize, float2(1.0f, -1.0f), float2(-1.0f, 1.0f)), 0.0f, 1.0f);
        texCoord = uv;
        color = col;
    }
...
vs_source_hlsl5 := [945]u8 {
    ...
    0x53,0x69,0x7a,0x65,0x2c,0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x28,0x31,0x2e,0x30,
